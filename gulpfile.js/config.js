...
module.exports = {
  ...
  copy: {
    ...
    // templates
    layout_src: src_path+'layout/*',
    layout_build: build_path+'layout/',
    snippets_src: src_path+'snippets/*',
    snippets_build: build_path+'snippets/',
    templates_src: src_path+'templates/*',
    templates_build: build_path+'templates/'
  },
